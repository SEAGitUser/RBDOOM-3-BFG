...
================
*/
cm_node_t* idCollisionModelManagerLocal::PointNode( const idVec3& p, cm_model_t* model ) const
{
...
================
*/
int idCollisionModelManagerLocal::PointContents( const idVec3 p, cmHandle_t model ) const
{
	int i;
	float d;
	cm_node_t* node;
...
==================
*/
int	idCollisionModelManagerLocal::TransformedPointContents( const idVec3& p, cmHandle_t model, const idVec3& origin, const idMat3& modelAxis ) const
{
