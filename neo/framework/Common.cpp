...
//SEA: was "developer", it conflicts with game's "developer"
idCVar com_developer( "com_developer", "1", CVAR_BOOL | CVAR_SYSTEM | CVAR_NOCHEAT, "developer mode" );
...
void idCommonLocal::CheckStartupStorageRequirements()
{
	...
	// ------------------------------------------------------------------------
	{
		...
		availableSpace = sys->GetDriveFreeSpaceInBytes( savepath );
...
void idCommonLocal::RenderSplash()
{
	...
	if( barHeight > 0.0f )
	{
		renderSystem->SetColor( idColor::black.ToVec4() );
