...
ID_INLINE idBoundsShort::idBoundsShort()
{
}
...
ID_INLINE const short * idBoundsShort::GetBounds()
{
	return b[0];
}


ID_INLINE void idBoundsShort::Clear()
{
	b[0][0] = b[0][1] = b[0][2] = 32767;
	b[1][0] = b[1][1] = b[1][2] = -32768;
}

ID_INLINE void idBoundsShort::Zero()
{
	b[0][0] = b[0][1] = b[0][2] =
	b[1][0] = b[1][1] = b[1][2] = 0;
}
...
ID_INLINE bool idBoundsShort::IsCleared() const {
	return b[0][0] > b[1][0];
}
...
ID_INLINE idBounds idBoundsShort::ToBounds() const
{
...
{
	idBoundsShort other = *this;
	other.AddBounds( a );
	return other;
}

ID_INLINE int idBoundsShort::GetLargestAxis() const
{
	short work[ 3 ];
	work[ 0 ] = b[ 1 ][ 0 ] - b[ 0 ][ 0 ];
	work[ 1 ] = b[ 1 ][ 1 ] - b[ 0 ][ 1 ];
