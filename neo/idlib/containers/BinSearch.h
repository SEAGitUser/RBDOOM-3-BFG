...
namespace idBinSearch
{
	...
	*/
	template< class type >
	ID_INLINE int Less( const type* array, const int arraySize, const type& value )
	{
		int len = arraySize;
		int mid = len;
		int offset = 0;
	...
	*/
	template< class type >
	ID_INLINE int LessEqual( const type* array, const int arraySize, const type& value )
	{
		int len = arraySize;
		int mid = len;
		int offset = 0;
	...
	*/
	template< class type >
	ID_INLINE int Greater( const type* array, const int arraySize, const type& value )
	{
		int len = arraySize;
		int mid = len;
		int offset = 0;
	...
	*/
	template< class type >
	ID_INLINE int GreaterEqual( const type* array, const int arraySize, const type& value )
	{
		int len = arraySize;
		int mid = len;
		int offset = 0;
