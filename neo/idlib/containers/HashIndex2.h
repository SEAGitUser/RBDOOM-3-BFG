...
#ifndef __HASHINDEX2_H__
#define __HASHINDEX2_H__
...
template< typename type, int Max, int NullIndex, int _DEFAULT_HASH_SIZE, int _DEFAULT_HASH_GRANULARITY >
...
public:
	...
	void			Write( class idFile* ) const;
	void			Read( class idFile* );
