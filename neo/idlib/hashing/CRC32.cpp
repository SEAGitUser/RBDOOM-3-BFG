...
void idHashing::CRC32_InitChecksum( unsigned int& crcvalue )
{
...
void idHashing::CRC32_UpdateChecksum( unsigned int& crcvalue, const void* data, int length )
{
	unsigned int crc;
...
void idHashing::CRC32_FinishChecksum( unsigned int& crcvalue )
{
	crcvalue ^= CRC32_XOR_VALUE;
}

unsigned int idHashing::CRC32_BlockChecksum( const void* data, int length )
{
	unsigned int crc;
