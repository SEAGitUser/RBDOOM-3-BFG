...
/*
=================
idRadAngles::NormalizeFull

returns angles normalized to the range [0 <= angle < TWO_PI]
=================
*/
idRadAngles &idRadAngles::NormalizeFull()
{
...
/*
=================
idRadAngles::NormalizeHalf

returns angles normalized to the range [-PI < angle <= PI]
=================
*/
idRadAngles &idRadAngles::NormalizeHalf()
{
	// Get to -TWO_PI < a < TWO_PI
	pitch = fmodf( pitch, idMath::TWO_PI );
	yaw = fmodf( yaw, idMath::TWO_PI );
...
/*
=================
idRadAngles::ToVectors
=================
*/
void idRadAngles::ToVectors( idVec3 *forward, idVec3 *right, idVec3 *up ) const
{
