...
private:
	...
	//static const int	JOINT_MAT_ROWS		= 0;
	//static const int	JOINT_MAT_SIZE		= 0;
	//static const int	JOINT_QUAT_ROWS		= 0;
	//static const int	JOINT_QUAT_SIZE		= 0;
...
public:
	...
	// Make this buffer a reference to another buffer.
	void				Reference( const idPixelPackBuffer& other );
	void				Reference( const idPixelPackBuffer& other, int refOffset, int refSize );
...
private:
	...
	DISALLOW_COPY_AND_ASSIGN( idPixelPackBuffer );
