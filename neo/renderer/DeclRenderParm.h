...
private:
	...
	// TODO
	// string Tex Tex2D Tex3D TexCube TexShadow2D TexShadow3D TexShadowCube TexArray2D TexArrayCube TexMultisample2D environment Sampler
	// Program Vec String StructuredBuffer UniformBuffer imageBuffer imageStoreBuffer2D imageStoreBuffer2DArray imageStoreBuffer3D Bool srgb srgba Range
	// setFreqLow
