...
public:
	...
	virtual const renderEntityParms_t* GetRenderEntity( qhandle_t entityHandle ) const = 0;
	...
	virtual const renderLightParms_t* GetRenderLight( qhandle_t lightHandle ) const = 0;
